...
public class HospitalSystemApplication {
  ...
  //     log.info("-------------------------------");
  //   //   pRepository.findAllByRegisteredHospitals(cityHospital).forEach(patient -> {
  //   //     log.info(patient.toString());
  //   //   });

	//   cityHospital.getPatients().forEach(patient -> {
  //       log.info(patient.toString());
  //     });
  ...
  //     log.info("-------------------------------");
  //     hRepository.findAllByRegisteredPatients(jack).forEach(h -> {
  //       log.info(h.toString());
  //     });
  //     log.info("");
  ...
  //   //   Patient patient = repository.findById(1L);
